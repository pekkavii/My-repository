...
document.addEventListener("DOMContentLoaded", function () {
    ...
    fetch('power_plants.json')
        ...
        .then(data => {
            ...
            function selectPlant(plant) {
                ...
                const rtrEl = document.getElementById("reactorTypeRow");
                rtrEl.style.display = "none";
                rtrEl.dataset.active = "false";
    ...
    document.getElementById("toggleControls").addEventListener("click", () => {
        ...
        // ▼ when expanded (click to collapse/hide)
        // ▲ when collapsed (click to expand/show)
        ...
        if (controls.classList.contains("collapsed")) {
            // Collapsing: hide the row via inline style
            reactorTypeRow.style.display = "none";
        } else {
            // Expanding: restore reactor type row if custom location is active
            // Use a data attribute on the row to remember its desired state
            const shouldShow = reactorTypeRow.dataset.active === "true";
            reactorTypeRow.style.display = shouldShow ? "block" : "none";
        }
    });
